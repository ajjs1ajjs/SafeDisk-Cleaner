...
- Scanner Engine: багатопотоковий обхід файлової системи (Temp, Crash Dumps, Browser Cache, Logs, Package Cache)
...
- Tauri UI (React + TypeScript): аналіз, категорії, кандидати, карантин, audit log
