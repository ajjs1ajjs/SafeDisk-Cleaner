...
AppPublisherURL=https://github.com/ajjs1ajjs/SafeDisk-Cleaner
AppSupportURL=https://github.com/ajjs1ajjs/SafeDisk-Cleaner/issues
AppUpdatesURL=https://github.com/ajjs1ajjs/SafeDisk-Cleaner/releases
SourceDir={#Root}
